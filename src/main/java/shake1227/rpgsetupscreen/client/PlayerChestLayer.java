...
import net.minecraft.world.entity.EquipmentSlot; // 追加
...
public class PlayerChestLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    private void addQuad(VertexConsumer builder, Matrix4f mat, org.joml.Matrix3f nMat, int light,
        ...
        Vector3f vA = new Vector3f(x2 - x1, y2 - y1, z2 - z1);
        Vector3f vB = new Vector3f(x4 - x1, y4 - y1, z4 - z1);
        Vector3f normal = new Vector3f();
        vA.cross(vB, normal);
        normal.normalize();

        vertex(builder, mat, nMat, x1, y1, z1, u1, v1, light, normal.x, normal.y, normal.z);
        vertex(builder, mat, nMat, x2, y2, z2, u2, v2, light, normal.x, normal.y, normal.z);
        vertex(builder, mat, nMat, x3, y3, z3, u3, v3, light, normal.x, normal.y, normal.z);
        vertex(builder, mat, nMat, x4, y4, z4, u4, v4, light, normal.x, normal.y, normal.z);
    }
